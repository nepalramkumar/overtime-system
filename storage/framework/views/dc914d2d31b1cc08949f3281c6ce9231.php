        ...
        <?php if(!empty($selectedEventId) && isset($events)): ?>
            ...
            <?php if($currentEvent): ?>
                <div class="bg-emerald-50 p-3.5 rounded-lg border border-emerald-200">
                    ...
                    <span class="text-slate-800 font-semibold text-base block mt-0.5"><?php echo e($currentEvent->event_name); ?> (<?php echo e($currentEvent->department); ?>)</span>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="remarks" class="w-full p-2.5 border border-slate-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm" rows="2" placeholder="कामको संक्षिप्त विवरण..."><?php echo e(old('remarks')); ?></textarea>

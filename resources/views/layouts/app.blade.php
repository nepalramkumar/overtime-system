...
<body class="font-sans antialiased bg-slate-100 text-slate-800" x-data="{ mobileSidebarOpen: false }">
    <div class="flex min-h-screen relative overflow-x-hidden">
            ...
            <div>
                ...
                <div class="p-5 border-b border-slate-700/70 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-lg bg-emerald-600 flex items-center justify-center shadow-md flex-shrink-0">
                            <i class="fas fa-clock text-white text-lg"></i>
                        </div>
                        <div class="leading-tight">
                            <h2 class="text-lg font-bold text-white">OT and Bills</h2>
                            <p class="text-xs text-emerald-300">व्यवस्थापन प्रणाली</p>
                        </div>
                    </div>
                ...
                <nav class="p-4 overflow-y-auto max-h-[calc(100vh-140px)] space-y-4">
                        ...
                        <ul class="space-y-1">
                            <li>
                                <a href="{{ route('dashboard') }}"
                                   ...
                                   {{ request()->routeIs('dashboard') ? 'bg-emerald-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-700 hover:text-white' }}">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('overtime.*') ? 'true' : 'false' }} }">
                        <button @click="open = !open" class="w-full flex items-center justify-between px-3 mb-2 text-xs uppercase text-slate-400 font-semibold tracking-wider hover:text-emerald-400 transition">
                            <span>Overtime</span>
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="{{ route('overtime.create') }}"
                                   ...
                                   {{ request()->routeIs('overtime.create') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('overtime.my') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('overtime.my') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('overtime.list') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('overtime.list') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('overtime.verified') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('overtime.verified') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
      ...
      <!-- Petrol -->
@if(userCan('petrol.bills.view') || userCan('petrol.bills.entry') || userCan('petrol.bills.manage') || userCan('petrol.months.manage') || userCan('repair.expenses.view') || userCan('repair.expenses.entry') || userCan('repair.expenses.manage'))
<div class="mb-5" x-data="{ open: true }">
    ...
    <ul class="space-y-1" x-show="open" x-transition>
        @if(userCan('petrol.bills.entry') || userCan('petrol.bills.manage'))
        <li>
            <a href="{{ route('petrol.bills.create') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition duration-150 text-sm font-medium
               {{ request()->routeIs('petrol.bills.create') ? 'bg-orange-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
        ...
        <li>
            <a href="{{ route('petrol.bills.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition duration-150 text-sm font-medium
               {{ request()->routeIs('petrol.bills.index') ? 'bg-orange-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
        ...
        @endif
        @if(userCan('repair.expenses.entry') || userCan('repair.expenses.manage'))
        <li>
            <a href="{{ route('repair.expenses.create') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition duration-150 text-sm font-medium
               {{ request()->routeIs('repair.expenses.create') ? 'bg-orange-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                <i class="fas fa-plus w-5 text-center"></i>
        ...
        <li>
            <a href="{{ route('repair.expenses.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition duration-150 text-sm font-medium
               {{ request()->routeIs('repair.expenses.index') ? 'bg-orange-600 text-white shadow-md' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
...
@endif
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="{{ route('users.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('users.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('hr-sync.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('hr-sync.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('employees.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('employees.index') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('employees.create') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('employees.create') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('positions.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('positions.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('purposes.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('purposes.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('shifts.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('shifts.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('settings.snack') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('settings.snack') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="{{ route('events.create') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('events.create') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            <li>
                                <a href="{{ route('reports.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('reports.index') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('reports.summary') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('reports.summary') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('reports.finance') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('reports.finance') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
            ...
            <div class="p-4 border-t border-slate-700/80 bg-slate-900/80 flex-shrink-0">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-full bg-emerald-600 text-white flex items-center justify-center flex-shrink-0 text-sm font-semibold uppercase shadow">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
            ...
            <!-- Top Header Bar -->
            <header class="bg-white shadow-sm border-b border-slate-200 px-4 sm:px-6 py-2.5 flex items-center justify-between flex-shrink-0">

        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-100">
                <tr>
                    ...
                    <th class="px-6 py-3 border">कार्यक्रम</th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 border"><?php echo e($rec->event->event_name ?? 'सामान्य'); ?></td>
                    <td class="px-6 py-4 border">
                        <form action="<?php echo e(route('overtime.verify', $rec->id)); ?>" method="POST" onsubmit="return confirm('के तपाईं यो रेकर्ड verify गर्न चाहनुहुन्छ?')">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">Verify</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="6" class="text-center p-4">कुनै pending record छैन।</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>

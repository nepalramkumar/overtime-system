...
<body class="font-sans antialiased bg-slate-100 text-slate-800" x-data="{ mobileSidebarOpen: false }">
                        ...
                        <ul class="space-y-1">
                            <li>
                                <a href="<?php echo e(route('dashboard')); ?>"
                                   ...
                                   <?php echo e(request()->routeIs('dashboard') ? 'bg-emerald-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-700 hover:text-white'); ?>">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="<?php echo e(route('overtime.create')); ?>"
                                   ...
                                   <?php echo e(request()->routeIs('overtime.create') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
    ...
    <a href="<?php echo e(route('events.list')); ?>"
       class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
       <?php echo e(request()->routeIs('events.list') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
        ...
        <span>Event OT Entry</span>
                            ...
                            <li>
                                <a href="<?php echo e(route('overtime.my')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('overtime.my') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('overtime.list')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('overtime.list') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('overtime.verified')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('overtime.verified') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="<?php echo e(route('users.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('users.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('hr-sync.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('hr-sync.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('employees.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('employees.index') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('employees.create')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('employees.create') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('positions.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('positions.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('purposes.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('purposes.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('shifts.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('shifts.*') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('settings.snack')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('settings.snack') ? 'bg-emerald-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="<?php echo e(route('events.create')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('events.create') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            <li>
                                <a href="<?php echo e(route('reports.index')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('reports.index') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('reports.summary')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('reports.summary') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('reports.finance')); ?>"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   <?php echo e(request()->routeIs('reports.finance') ? 'bg-emerald-600 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white'); ?>">
            ...
            <div class="p-4 border-t border-slate-700/80 bg-slate-900/80 flex-shrink-0">
                <div class="flex items-center gap-3">
                    ...
                    <div class="leading-tight overflow-hidden">
                        ...
                        <p class="text-xs text-emerald-400 capitalize"><?php echo e(auth()->user()->role); ?></p>
                    </div>
                </div>
            </div>

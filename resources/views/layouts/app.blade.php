        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 text-slate-100 flex-shrink-0 shadow-xl flex flex-col justify-between transform transition-transform duration-300 lg:static lg:translate-x-0"
            ...
            <div>
                ...
                <nav class="p-4 overflow-y-auto max-h-[calc(100vh-140px)] space-y-4">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('petrol.*') || request()->routeIs('repair.*') ? 'true' : 'false' }} }">
                        ...
                        <ul class="space-y-1 pl-2 border-l-2 border-slate-700" x-show="open" x-transition x-cloak>
                            ...
                            <li>
                                <a href="{{ route('petrol.bills.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('petrol.bills.*') ? 'bg-amber-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('petrol.months.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('petrol.months.*') ? 'bg-amber-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">
                            ...
                            <li>
                                <a href="{{ route('repair.expenses.index') }}"
                                   class="flex items-center gap-3 px-3 py-2 rounded-lg transition duration-150 text-sm font-medium
                                   {{ request()->routeIs('repair.expenses.*') ? 'bg-amber-700 text-white shadow-sm' : 'text-slate-300 hover:bg-slate-700/70 hover:text-white' }}">

...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
            <a href="<?php echo e(route('reports.exportSummaryExcel', request()->all())); ?>" 
    ...
    <!-- Filter Form -->
    <form action="<?php echo e(route('reports.summary')); ?>" method="GET" class="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
            <div>
                <label class="block text-xs font-semibold text-slate-700 mb-1.5">From Date</label>
                <input type="date" name="from_date" value="<?php echo e(request('from_date')); ?>" class="w-full border border-slate-300 rounded-lg text-xs p-2.5">
            </div>
            <div>
                <label class="block text-xs font-semibold text-slate-700 mb-1.5">To Date</label>
                <input type="date" name="to_date" value="<?php echo e(request('to_date')); ?>" class="w-full border border-slate-300 rounded-lg text-xs p-2.5">
            </div>
            <div>
            ...
            <div class="flex gap-2 items-center">
                ...
                <a href="<?php echo e(route('reports.summary')); ?>" class="bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 text-xs px-4 py-2.5 rounded-lg transition font-medium">
                    Reset
                </a>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition">
                        ...
                        <td class="p-3 text-slate-700">
                            <?php echo e($data->event->event_name ?? 'सामान्य'); ?>
                        ...
                        <td class="p-3 text-center font-mono text-slate-700"><?php echo e($data->date_from); ?> - <?php echo e($data->date_to); ?></td>
                        ...
                        <td class="p-3 text-right font-semibold text-slate-900">रु <?php echo e(number_format($data->total_lunch, 2)); ?></td>
                    </tr>

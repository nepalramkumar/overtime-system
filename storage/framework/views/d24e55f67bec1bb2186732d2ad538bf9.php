...
<div class="mb-4">
                ...
                <input type="number" name="hierarchy" value="<?php echo e(old('hierarchy', $employee->hierarchy)); ?>" class="w-full border p-2 rounded focus:ring-2 focus:ring-blue-500" min="1">

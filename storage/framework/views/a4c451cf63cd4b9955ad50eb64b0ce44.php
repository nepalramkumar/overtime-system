...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
        ...
        <form action="<?php echo e(route('shifts.store')); ?>" method="POST" class="flex gap-2 mb-6 bg-blue-50 p-4 rounded">
            <?php echo csrf_field(); ?>
            <input type="text" name="day_name" placeholder="दिनको नाम (जस्तै: Sunday)" class="border p-2 w-full" required>
            ...
            <tbody>
                ...
                <tr>
                    <form action="<?php echo e(route('shifts.update', $shift->id)); ?>" method="POST">
                        ...
                        <td class="border p-2"><input type="text" name="day_name" value="<?php echo e($shift->day_name); ?>" class="w-full p-1"></td>

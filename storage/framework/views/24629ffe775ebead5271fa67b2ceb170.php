    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
        ...
        <table id="positionTable" class="w-full border-collapse border border-gray-200 mb-8">
            ...
            <tbody>
                ...
                <tr class="pos-row">
                    <td class="border p-2 text-center font-semibold pos-name"><?php echo e($item->name); ?>  </td>
                    <td class="border p-2 text-center">
                        <form action="<?php echo e(route('positions.updateRate', $item->id)); ?>" method="POST" class="flex justify-center gap-2">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                            <input type="number" name="level" value="<?php echo e($item->level); ?>" class="border p-1 w-20 text-center" placeholder="0">  
